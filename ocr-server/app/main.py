...
async def run_ocr(
    ...
    result = ocr.predict(rgb, return_word_box=True)
    ...
    results_out = [
        {
            ...
            "per_char_confidences": r["per_char_confidences"],
            "char_candidates": r["char_candidates"],
            "chars": r["chars"],
            "char_confidence_available": r["char_confidence_available"],
            "char_candidates_available": r["char_candidates_available"],
            "char_box_available": r["char_box_available"],
            "bbox": r["bbox"],
            "column": r["column"],
        }
        for r in ordered
